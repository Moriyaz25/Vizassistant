                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-6 mb-8">
                            <div className="relative group">
                                <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-primary to-[#667D9D] p-1 shadow-lg shadow-primary/20 overflow-hidden">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-[#667D9D]/14 rounded-lg text-[#667D9D]">
