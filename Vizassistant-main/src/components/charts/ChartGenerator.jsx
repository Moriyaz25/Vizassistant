...
const COLORS = ['#16254F', '#667D9D', '#ACBBC6', '#4D6380', '#7E93AF', '#CBD5DC']
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-primary/10 to-accent/10 rounded-3xl blur opacity-20 group-hover:opacity-30 transition duration-1000 group-hover:duration-200" />
