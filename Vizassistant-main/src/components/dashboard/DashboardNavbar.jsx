        ...
        <header className="h-16 bg-card/80 border-b border-border backdrop-blur-2xl sticky top-0 z-30 flex items-center justify-between px-4 md:px-8 shrink-0">
            <div className="flex items-center gap-4">
                ...
                <Link to="/" className="md:hidden flex items-center gap-2">
                    <div className="h-7 w-7 flex items-center justify-center rounded-lg bg-primary/15 border border-primary/20">
            ...
            <div className="flex items-center gap-3">
                ...
                <button className="relative p-2.5 rounded-xl bg-muted hover:bg-muted/80 border border-border text-muted-foreground hover:text-foreground transition-all">
                    ...
                    <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-primary rounded-full border-2 border-card shadow-[0_0_6px_rgba(102,125,157,0.5)]" />
                </button>
                ...
                >
                    <div className="hidden sm:block text-right">
                        <p className="text-sm font-bold text-foreground group-hover:text-primary transition-colors leading-none mb-1">
                            {firstName}
                        </p>
                        <p className="text-[10px] text-muted-foreground font-medium">Free Plan</p>
                    </div>
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#16254F] to-[#667D9D] p-[1.5px] shadow-lg shadow-[#060817]/15 group-hover:scale-105 transition-transform duration-300">
